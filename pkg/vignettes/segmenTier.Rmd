...
matrix, and scoring function "icor" requires only a
...
"User-Defined Similarities". However, `segmenTier` provides a complete
pipeline of time-series processing and clustering functions that is to
some extent specific to the data for which the algorithm was
developed, but should also be generally applicable.
